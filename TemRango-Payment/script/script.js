...
const section = document.getElementsByClassName("align-section")
const nav = document.getElementsByClassName("nav")
const moneyCheck = document.getElementsByClassName("label-switch")
const saveButton = document.getElementsByClassName("save__button")
...
const input = document.getElementsByClassName("input-in")
let first = true
list = []
listParents = []
...
input[0].addEventListener("focus", ()=>{
	green[0].style.borderTop = "2px solid #05CB95"
	green[0].style.borderLeft = "2px solid #05CB95"
	green[0].style.borderBottom = "2px solid #05CB95"
	green[0].style.top = "-1px"
	green[0].style.width = "144.5px"
	input[0].style.borderTop = "2px solid #05CB95"
	input[0].style.borderRight = "2px solid #05CB95"
	input[0].style.borderBottom = "2px solid #05CB95"
	input[0].style.color = "#05CB95"
})

input[0].addEventListener("focusout",()=>{
	green[0].style.borderTop = ""
	green[0].style.borderLeft = ""
	green[0].style.borderBottom = ""
	green[0].style.top = ""
	green[0].style.width = ""
	input[0].style.borderTop = ""
	input[0].style.borderRight = ""
	input[0].style.borderBottom = ""
	input[0].style.color = ""
})

moneyCheck[0].addEventListener("click", ()=>{
	acttiveCheck(0)
})

moneyCheck[1].addEventListener("click", ()=>{
	acttiveCheck(1)
})

moneyCheck[2].addEventListener("click", ()=>{
	acttiveCheck(2)
})


options[0].addEventListener("click", ()=>{
	input[0].placeholder = event.target.attributes[1].value
	green[0].innerText = event.target.innerText
})

select[0].addEventListener("click", ()=>{
	
	if(options[0].style.display == "none"){
		green[0].style.backgroundImage = "none"
		green[0].style.color = "#05CB95"
		green[0].style.backgroundColor = "#E0F2ED"
		...
		green[0].style.width = ""
		green[0].style.top = ""
		green[0].style.backgroundImage = ""
		green[0].style.color = ""
		green[0].style.backgroundColor = ""
		Array.from(options).forEach(item=>{
			item.style.display = "none"
		})
		green[0].style.border = ""
...
buttons[0].addEventListener("click", ()=>{
	...
	nav[0].children[1].style.display = "none"
	nav[0].children[2].style.display = "flex"
	container[0].children[3].style.display = "block"
})
...
buttons[1].addEventListener("click", ()=>{
	...
	nav[0].children[1].style.display = "none"
	nav[0].children[2].style.display = "flex"
	container[0].children[4].style.display = "block"
})
...
buttons[2].addEventListener("click", ()=>{
	...
	nav[0].children[1].style.display = "none"
	nav[0].children[2].style.display = "flex"
	container[0].children[2].style.display = "flex"
})
...
function acttiveCheck(index){
	var text = document.getElementsByClassName("text")
	if(moneyCheck[index].control.checked != false){
		text[(1+(index*2))].style.display = "none"
		text[(0+(index*2))].style.display = "block"
		first = false
	}

	else{
		text[(0+(index*2))].style.display = "none"
		text[(1+(index*2))].style.display = "block"
		first = false
	}


	if(first == false){
		saveButton[index].classList.add("save__button--altered")
	}
}
...
function changeMenu(){
	if(menu[0].style.display == "block"){
		...
		mask[0].style.visibility = "visible"
		container[0].style.position = "fixed"
		container[0].style.marginLeft = "169.5px"
		mask[0].addEventListener('click', ()=>{
			anima(1,0,0)
			menu[0].style.display = "none"
			mask[0].style.visibility = "hidden"
